...
from .parking_environment_safe_core_negative import plot_arrow, calculate_overlap_area
from .parking_environment_safe_core_negative import distance_point_to_segment, point_to_polygon_distance
from .parking_environment_safe_core_negative import ceter_to_rear, rear_to_ceter
from .parking_environment_safe_core_negative import is_point_in_rectangle, position_vehicle_vertex
from .parking_environment_safe_core_negative import env_stop_condition, compute_env_reward
from .parking_environment_safe_core_negative import compute_vehicle_pos, compute_vehicle_pos_hybrid_com
from .parking_environment_safe_core_negative import Perpendicular_parking, Perpendicular_parking_hybrid, Perpendicular_parking_hybrid_boundary
from .parking_environment_safe_core_negative import Perpendicular_parking_hybrid_boundary
from .parking_environment_safe_core_negative import generate_init_vehicle, get_init_vehicle_pos
from .parking_environment_safe_core_negative import generate_target_parking,  get_target_parking_pos
from .parking_environment_safe_core_negative import get_init_vehicle_area, vehicle_wall_obstacle
from .parking_environment_safe_core_negative import ego_vehicle_vertex_midpoints, lidar_detection_distance
from .parking_environment_safe_core_negative import Parallel_parking_hybrid_boundary, get_target_parking_pos_parallel
from .parking_environment_safe_core_negative import vehicle_wall_obstacle_parallel, get_init_vehicle_area_parallel
from .parking_environment_safe_core_negative import get_init_vehicle_pos_parallel, compute_env_reward_parallel
...
class PerpendicularParkEnv_Safe_Negative(gym.Env):
    '''
    ...
    def __init__(self):
        ...
        '''
        super(PerpendicularParkEnv_Safe_Negative, self).__init__()
    ...
    def render_park_trajectory(
        ...
        # # 绘制所有点的车辆
        # print('len_all_pints:', all_points)
        # print('all_points[i]:', all_points[0])
        ...
        for i in range(len(all_points)):
            ...
            # print('point_vehicle_vert:', len(point_vehicle_vert[0]))
            # print('point_vehicle_vert:', len(point_vehicle_vert))
            # quit()
...
class ParallelParkEnv_Safe_Negative(gym.Env):
    '''
    ...
    def __init__(self):
        ...
        Init the environment
        '''
        super(ParallelParkEnv_Safe_Negative, self).__init__()
       
        self.action_dim = 3       # 离散动作维度
        self.state_dim = 17       # 观测状态维度
        self.max_steps = 50       # 环境最大步数
        self.current_step = 0     # 初始化当前步数
        self.park_bounary = 0.5   # 停车场边界宽度
    ...
    def reset(self, train_stage=1, eval_stage=False):
        ...
        while reset_flag:
            ...
            # 库位障碍及停车场周围墙壁
            self.park_vehicle_polygons, self.park_vertex_polygon = vehicle_wall_obstacle_parallel(
                parking_spaces = self.parking_spaces,
                park_vertex = self.park_vertex,
                vehicle_config = self.vehicle_config,
                target_parking_id = self.target_parking_id,
