...
from hcrl.hcrl_core import combined_shape
from hcrl.hcrl_core import discount_cumsum
from hcrl.hcrl_core import statistics_scalar
from hcrl.hcrl_core import HCRL
from hcrl.hcrl_model import HCRL_Model
from hcrl.hcrl_model_safe import HCRL_Model_Safe
from hcrl.hcrl_policy import HCRLPolicy
from hcrl.hcrl_policy_safe_parallel import HCRLPolicy_Safe


class HPPOBuffer_Safe:
    """
...
def record_result(run_name, env_id, eval_result):
    '''
...
def main(args):
    ...
    for epoch in tqdm(range(Eval_step_epoch), desc='Train Loop:'):

        # Load the parameters model for the policy network
        load_model(
            hppo_policy._model,
        ...
        # Evaluation the policy network
        hppo_policy.evaluate_policy(
            eval_epoch = args.eval_step,
            seed = args.seed,
            env_id = args.env,
        )
...
if __name__ =='__main__':
    ...
    # parser.add_argument('--model_dir', type=str, default='./hcrl_model_pth/Perpendicular/wobbly-terrain-134/model_2800_1.0_0.4995902742925641_.pth' )
    # parser.add_argument('--model_dir', type=str, default='./hcrl_model_pth/Perpendicular/wobbly-terrain-134/model_3880_1.0_7.253447013970158_.pth' )
    parser.add_argument('--model_dir', type=str, default='./Model_path/hcrl_safe/Perpendicular/royal-microwave-157/model_6440_1.0_9.815708574176199_.pth' )
