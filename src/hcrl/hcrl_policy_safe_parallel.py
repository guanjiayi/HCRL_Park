...
def visualize_path(
    ...
    plt.tick_params(axis='both', which='major', labelsize=34)  # Main scale
    ...
    plt.text(0.5, 8, "C$_s$ = 2.15; N$_g$ = 2; T$_c$ = 0.07", fontsize=34, color="k")
    # plt.text(3, 5.5, "T$_c$ = 0.07", fontsize=24, color="k")
    plt.title("HCRL", fontsize=36)
    save_dir = './view_trajectory/fig_hcrl_parallel_v05'
    plt.grid()
...
def calculate_movement_type(path_points):
    ...
    for i in range(len(path_points) - 1):
        ...
        # Calculate the included angle between the heading angle and the direction of motion
